...
# -*- coding: utf-8 -*-
"""
Created on Thu Jul 18 14:27:38 2019
...
#    print("Community =", C)
    ...
    with open('communities/tce_communities'+str(myFile), 'a') as out_file:
              
#        writer = csv.writer(out_file, delimiter=';')
        
        if os.stat('communities/tce_communities'+str(myFile)).st_size == 0:
#            writer.writerow(["Node 1", "Node 2", "Multiplied Weight", "Seed node", "Community"])
#            writer.writerow(["Seed node", "Community"])
            out_file.write("Seed node"+ '    ' +"Community"+'\n')
