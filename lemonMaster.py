...
#########################################################################################
    ...
    parser.add_option("-f", "--input network file", dest="network_file", default="lemonDatasets/lfr/NetColUn<11111-11111>1.",
                      help="input file of edge list for clustering [default: example_graphs/amazon/graph]")

    parser.add_option("-g", "--input community ground truth file", dest="groundtruth_community_file", default="lemonDatasets/lfr/communityFile.txt",
    ...
    parser.add_option("--sd", "--input seed set file", dest="seed_set_file", default="lemonDatasets/lfr/seedsetFile",
