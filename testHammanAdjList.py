...
###############################################################################
while len(S)>0: #oi komvoi tou S auksanontai synexws. Arxika 170.
    ...
    for u in S:
        ...
        score_array.append(SCORE(u, S, C, weights)) #values
...
#    print("umax =", umax)
    ...
    if (conOfCWithUmax<conOfC ): #isxuei panta gi'auto auksanontai oi komvoi tou S.
        if (type(C) != list):
            C = C.tolist()
        C.append(umax)
