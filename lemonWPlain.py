...
#########################################################################################
    ...
    parser.add_option("-f", "--input network file", dest="network_file", default="lemonDatasets/lfr/new",
                      help="input file of edge list for clustering [default: example_graphs/amazon/graph]")

    parser.add_option("-g", "--input community ground truth file", dest="groundtruth_community_file", default="lemonDatasets/lfr/communities",
                      help="input file of ground truth community membership [default: example_graphs/amazon/community]")

    parser.add_option("--out", "--output file", dest="output_file", default="lemonDatasets/lfr/output.txt",
                      help="output file of detected community [default: output.txt]")

    parser.add_option("--sd", "--input seed set file", dest="seed_set_file", default="lemonDatasets/lfr/seed",
    ...
    parser.add_option("-z", "--seed set size", dest="ini_num_of_seed", default=2,
